...
class algorithm
{
    ...
    public static function evolvePopulation(population $pop)
    {
        ...
        // crossover
        for ($i = $elitismOffset; $i < $popSize; $i += 2) {
        ...
        // Mutate population
        for ($i = $elitismOffset; $i < $popSize; $i++) {
    ...
    private static function crossover(individual $indiv1, individual $indiv2)
    {
        ...
        $indivSize = $indiv1->size();
        // Loop through genes
        for ($i = 0; $i < $indivSize; $i++) {
    ...
    {
        // Loop through genes
        for ($i = 0, $indivSize = $indiv->size(); $i < $indivSize; $i++) {
    ...
    private static function poolSelection(population $pop)
    {
        ...
        for ($i = 0; $i < algorithm::$poolSize; $i++) {
            $randomId = rand(0, $popSize - 1); //Get a random individual from anywhere in the population//TODO:FUNCTION FOR RANDOM WITH INPUT TYPE OF RANDOM
